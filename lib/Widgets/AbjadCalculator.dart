...
import 'package:gohar_shahi/Widgets/NameNumberCalculator.dart';
...
class _UrduAbjadCalculatorState extends State<UrduAbjadCalculator>
  ...
  final Map<String, int> abjadMap = {
    ...
    'ذ': 700, 'ر': 200, 'ڑ': 200, 'ز': 7, 'ژ': 7, 'س': 60,
    'ش': 300, 'ص': 90, 'ض': 800, 'ط': 9, 'ظ': 900, 'ع': 70,
    'غ': 1000, 'ف': 80, 'ق': 100, 'ک': 20, 'گ': 20, 'ل': 30,
    'م': 40, 'ن': 50, 'ں': 50, 'و': 6, 'ہ': 5, 'ھ': 5,
    'ء': 0, 'ی': 10, 'ے': 10,
  };
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Abjad Calculator"),
          centerTitle: true,
          bottom: const TabBar(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    'جیسے "اللہ" کا عدد 66 ہے، اس لیے اللہ کا نام 66 بار پڑھنا روحانیت کے لیے بہترین سمجھا جاتا ہے۔  دین الہی میں صفحہ نمبر 15 پر بھی ابجد کا ذکر کیا گیا ہے '
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: const TextStyle(fontFamily: "urdu"),
